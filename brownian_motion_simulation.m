...
% function of time and comparing simulated results with theoretical predictions.
%
% Author: [Hasan Ubaid Ullah]
% Date: [20250929]
% =========================================================================
...
% Set figure size and DPI (1200 for high resolution)
figure('Position', [100, 100, 1400, 500]); % Resize figure
...
% ---------------------------------------------------------------------
subplot(1, 3, 2);
histogram(dSquaredDisplacement, 25);
